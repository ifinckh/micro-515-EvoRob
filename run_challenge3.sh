#!/bin/bash
#SBATCH --job-name=ER_Challenge3                # Job name
#SBATCH --output=logs/ER_Challenge3_%j.out      # Standard output file (%j will be replaced by the job ID)
#SBATCH --error=logs/ER_Challenge3_%j.err       # Standard error file
...
#SBATCH --time=10:00:00                          # Expected runtime (hours:minutes:seconds)
